...
struct expression_cast_to_vector_visitor : static_visitor<error_storage>
{
    ...
    annium_vector_t const& target;
    context_locator_t cl_;

    expression_cast_to_vector_visitor(fn_compiler_context& c, annium_vector_t const& t, context_locator_t const& cl)
        : ctx{ c }
        , target{ t }
        , cl_{ cl }
    {}
    ...
    */
    ...
    result_type operator()(annium_tuple_t const& v) const;
