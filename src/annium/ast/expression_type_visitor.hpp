...
struct expression_type_visitor : static_visitor<optional<annium_type>>
{
    fn_compiler_context& ctx;
    annium_type const& expected_tp;
    std::vector<semantic::expression_t>& result;

    expression_type_visitor(fn_compiler_context& c, annium_type const& t, std::vector<semantic::expression_t>& r)
        : ctx{ c }
        , expected_tp{ t }
        , result{ r }
    {}
