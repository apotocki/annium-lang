...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      char dummy23[sizeof (parameter_constraint_modifier_t)];

      // parameter-list-opt
      // parameter-list
      char dummy24[sizeof (parameter_list_t)];

      // parameter-decl
      char dummy25[sizeof (parameter_t)];

      // subpatterns
      // pattern-list
      char dummy26[sizeof (pattern_list_t)];

      // pattern
      char dummy27[sizeof (pattern_t)];

      // pattern-field-sfx
      // pattern-field
      char dummy28[sizeof (pattern_t::field)];
      ...
      // fn-start-decl
      char dummy34[sizeof (std::pair<sonia::lang::lex::resource_location, fn_kind>)];
