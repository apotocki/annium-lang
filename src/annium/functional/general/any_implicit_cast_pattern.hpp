...
class any_implicit_cast_pattern : public functional::pattern
{
public:
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "implicit_cast(_)~>any"; }
};
