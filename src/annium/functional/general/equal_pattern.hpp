...
public:
    ...
    inline equal_pattern() noexcept : functional::pattern{ functional::default_pattern_implementation_weight } {}
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "equal(~$LT, ~$RT)->bool"; }
};
