...
#define OPERATOR_ENUM (POSTFIX_INCREMENT)(POSTFIX_DECREMENT)(PERIOD)(ARROW)(DBLCOLON)(POSTFIX_CLOSE_BROKET)(POSTFIX_RIGHTSHIFT) \
    ...
    (LESS)(LE)(GREATER)(GE)\
    (BITXOR)\
    (IFF)(ADDASSIGN)(SUBASSIGN)(MULASSIGN)(DIVASSIGN)(MODASSIGN)(LSHIFTSSIGN)(RSHIFTSSIGN)(BITANDASSIGN)(BITORASSIGN)(BITXORASSIGN)(THROW)\
    (COMMA)
*/

#define ANNIUM_UNARY_OPERATOR_ENUM (NEGATE)(DEREF)(ELLIPSIS)(MINUS)
#define ANNIUM_BINARY_OPERATOR_ENUM (ASSIGN)(LOGIC_AND)(LOGIC_OR)(BIT_OR)(BIT_AND)(CONCAT)(PLUS)(MINUS)(MUL)(DIV)(EQ)(NE)(LESS)(LESS_EQ)(GREATER)(GREATER_EQ)(CAST)
