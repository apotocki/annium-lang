...
parameter_type_expression_visitor::result_type parameter_type_expression_visitor::operator()(qname_reference const& var)
{
...
parameter_type_expression_visitor::result_type parameter_type_expression_visitor::operator()(annium_parameter_pack_t const& ppack)
{
