...
public:
    ...
    //void set_fn_signature(environment&, entity_signature&& fnsig);
    //void build_fn_signature(environment& e, entity_identifier rt);
...
public:
    ...
    //    : variable_entity{ std::move(eid), std::move(name), annium_type{sig.fn_type}, kind::LOCAL }
    ...
    annium_type const& result_type() const { return fsignature().fn_type.result; }
