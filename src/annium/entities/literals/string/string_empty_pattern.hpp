...
class string_empty_pattern : public functional::pattern
{
public:
    string_empty_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "empty(constexpr string)->bool"sv; }
};
