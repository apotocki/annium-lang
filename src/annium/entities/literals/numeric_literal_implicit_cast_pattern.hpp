...
public:
    ...
    { return s << "implicit_cast(:integer|decimal|bool|i8|u8|i16|u16|i32|u32|i64|u64|f16|f32|f64)->integer|decimal|bool|i8|u8|i16|u16|i32|u32|i64|u64|f16|f32|f64"sv; }
};
