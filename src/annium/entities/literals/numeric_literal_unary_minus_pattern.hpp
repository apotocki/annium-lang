...
class numeric_literal_unary_minus_pattern : public functional::pattern
{
public:
    numeric_literal_unary_minus_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "minus(:~$T @is_numeric)->$T"sv; }
};
