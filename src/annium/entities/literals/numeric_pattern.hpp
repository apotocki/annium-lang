...
// compile-time predicate: numeric(t: typename) -> bool
// true for the fixed-width integer/float builtins, bigint (integer) and decimal; false for everything else
class numeric_pattern : public functional::pattern
{
public:
    explicit numeric_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "numeric(t: typename)->bool"; }
};
