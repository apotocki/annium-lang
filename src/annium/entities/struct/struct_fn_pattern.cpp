...
std::expected<syntax_expression_result, error_storage> struct_fn_pattern::apply(fn_compiler_context& ctx, semantic::expression_list_t&, functional_match_descriptor& md) const
{
