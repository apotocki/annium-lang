...
#include "annium/entities/tuple/generic_get_pattern_matcher.ipp"
...
struct stucture_get_pattern_matcher : public generic_get_pattern_matcher<stucture_get_pattern_matcher>
{
    ...
    std::expected<functional_match_descriptor_ptr, error_storage> create_match_descriptor()
    {
        ...
        return make_shared<struct_get_match_descriptor>(call, get_entity(e, *uteid));
    }
};
...
//        e.push_back_expression(exprs, semantic::push_value{ smd.property_index() });
//        e.push_back_expression(exprs, semantic::invoke_function(e.get(builtin_eid::array_at)));
//    }
//    
