...
class is_struct_pattern : public functional::pattern
{
public:
    explicit is_struct_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "is_struct(typename @structure)->bool"; }
};
