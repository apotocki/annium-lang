...
class struct_set_pattern : public functional::pattern
{
public:
    struct_set_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "set(self $self: @structure, property: constexpr __identifier, $value) -> $self"; }
};
