...
std::expected<syntax_expression_result, error_storage> tuple_empty_pattern::apply(fn_compiler_context& ctx, semantic::expression_list_t& el, functional_match_descriptor& md) const
{
