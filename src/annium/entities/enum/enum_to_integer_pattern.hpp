...
class enum_to_integer_pattern : public functional::pattern
{
public:
    enum_to_integer_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "to_integer(:@enumeration)->integer"sv; }
};
