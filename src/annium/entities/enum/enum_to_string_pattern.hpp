...
class enum_to_string_pattern : public functional::pattern
{
public:
    enum_to_string_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "to_string(:@enumeration)->string"sv; }
};
