...
class enum_equal_pattern : public functional::pattern
{
public:
    //enum_equal_pattern() noexcept : functional::pattern{ numetron::decimal{ "0.1"sv } } {}
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "equal(:@enumeration, :@enumeration)->bool"sv; }
};
