...
class array_from_iterator_make_pattern : public functional::pattern
{
public:
    array_from_iterator_make_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "make_array(from_iterator)->auto"sv; }
};
