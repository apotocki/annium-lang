...
class fixed_array_head_pattern : public functional::pattern
{
public:
    fixed_array_head_pattern() = default;
    ...
    std::ostream& print(environment const&, std::ostream& s) const override { return s << "head(array(of $E, ...)) ~> $E"sv; }
};
